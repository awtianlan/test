...
//        title.drawString("my head", 100, (H_title)/2+5);
        ...
        if(bimg!=null){
            mainPic.drawImage(bimg, 0, 0, imageWidth, 200, null);
            mainPic.dispose();
        }
//        //***********************设置下面的提示框
//
...
//        btn2.drawString("单击我啊", 120, btn2_2_top+(H_btn/2)+5);
        ...
        createImage("C:\\Users\\Administrator\\Desktop\\1.jpg");
    ...
    public static void main(String[] args) {
        ...
        try {
            cg.graphicsGeneration("ewew", "1", "12", "C:\\Users\\Administrator\\Desktop\\timg.jpg");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
